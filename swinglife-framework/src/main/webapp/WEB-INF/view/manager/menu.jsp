				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
					...
					<ul class="dropdown-menu dropdown-sm pull-right user-dropdown">
						<li class="user-avatar"><img
							src="/resources/images/profile/profile1.jpg" alt=""
							class="img-circle">
				...
				<div class="user-block hidden-xs">
					...
					<div class="panel border dropdown-menu user-panel">
						<div class="panel-body paddingTB-sm">
							<ul>
								<li><a href="profile.html"> <i class="fa fa-edit fa-lg"></i><span
										class="m-left-xs">My Profile</span>
								</a></li>
					...
					<li><a href="#" data-toggle="dropdown"><i
						...
						<ul class="dropdown-menu message pull-right">
							...
							<li><a class="clearfix" href="#"> <img
									src="/resources/images/profile/profile2.jpg" alt="User Avatar">
									<div class="detail">
							...
							<li><a class="clearfix" href="#"> <img
									src="/resources/images/profile/profile3.jpg" alt="User Avatar">
									<div class="detail">
							...
							<li><a class="clearfix" href="#"> <img
									src="/resources/images/profile/profile4.jpg" alt="User Avatar">
							...
							<li><a class="clearfix" href="#"> <img
									src="/resources/images/profile/profile5.jpg" alt="User Avatar">
									<div class="detail">
			...
			<ul class="accordion">
				...
				<li class="bg-palette1 "><a href="index.html"> <span
						class="menu-content block"> <span class="menu-icon"><i
								class="block fa fa-home fa-lg"></i></span> <span class="text m-left-sm">控制面板</span>
					</span> <span class="menu-content-hover block"> Home </span>
				</a></li>
				<li
					class="openable bg-palette2 <c:if test="${menu=='system' }">open</c:if>">
					<a href="#"> <span class="menu-content block"> <span
							class="menu-icon"><i class="block fa fa-desktop fa-lg"></i></span>
							<span class="text m-left-sm">系统管理</span> <span
							class="submenu-icon"></span>
					</span> <span class="menu-content-hover block"> Form </span>
				</a>
					<ul class="submenu bg-palette4"
						<c:if test="${menu=='system' }">style='display:block'</c:if>>
						<li <c:if test="${subMenu=='adminList' }">class="active"</c:if>><a
				...
				<c:forEach items="${leftParentMenu}" var="list" varStatus="id">
					<li class="openable bg-palette${id.index+3 }"><a href="#">
							<span class="menu-content block"> <span class="menu-icon"><i
									class="block fa ${list.icon } fa-lg"></i></span> <span
								class="text m-left-sm">${list.name }</span> <span class="submenu-icon"></span>
						</span> <span class="menu-content-hover block"> Form </span>
					</a>
						<ul class="submenu bg-palette${id.index+3+1 }">
							<c:forEach items="${list.subMenus }" var="sub">
								<li><a href="${sub.url }"><span class="submenu-label">${sub.name }</span></a></li>
							</c:forEach>
				...
				<li class="openable bg-palette4"><a href="#"> <span
						class="menu-content block"> <span class="menu-icon"><i
								class="block fa fa-tags fa-lg"></i></span> <span class="text m-left-sm">UI
								Elements</span> <span class="submenu-icon"></span>
					</span> <span class="menu-content-hover block"> UI Kits </span>
				</a>
					<ul class="submenu">
						<li><a href="ui_element.html"><span class="submenu-label">Basic
									Elements</span></a></li>
				...
				<li class="openable bg-palette3"><a href="#"> <span
						class="menu-content block"> <span class="menu-icon"><i
								class="block fa fa-gift fa-lg"></i></span> <span class="text m-left-sm">Extra
								Pages</span> <span class="submenu-icon"></span>
					...
					<ul class="submenu">
						...
						<li><a href="signup.html"><span class="submenu-label">Sign
									Up</span></a></li>
						<li><a href="lockscreen.html"><span class="submenu-label">Lock
									Screen</span></a></li>
				...
				<li class="openable bg-palette4"><a href="#"> <span
						class="menu-content block"> <span class="menu-icon"><i
								class="block fa fa-list fa-lg"></i></span> <span class="text m-left-sm">Menu
								Level</span> <span class="submenu-icon"></span>
