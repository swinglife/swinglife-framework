...
<html lang="en">
  	...
  	<body class="overflow-hidden">
				...
				<div class="sidebar-inner scrollable-sidebar">
						...
						<ul class="sidebar-list">
							<li>
								<a href="#" class="clearfix">
									<img src="/resources//resources/images/profile/profile2.jpg" class="img-circle" alt="user avatar">
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources//resources/images/profile/profile3.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											Jane Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources//resources/images/profile/profile4.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources//resources/images/profile/profile5.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
					...
					<div class="content-block">
						<ul class="sidebar-list">
							<li>
								<a href="#" class="clearfix">
									<img src="/resources//resources/images/profile/profile6.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources/images/profile/profile7.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											Jane Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources/images/profile/profile8.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
							...
							<li>
								<a href="#" class="clearfix">
									<img src="/resources/images/profile/profile9.jpg" class="img-circle" alt="user avatar">
									<div class="chat-detail m-left-sm">
										<div class="chat-name">
											John Doe
										</div>
													...
													<ul class="chat">
														<li class="left clearfix">
															<span class="chat-img pull-left">
																<img src="/resources/images/profile/profile2.jpg" alt="User Avatar">
															</span>
														...
														<li class="right clearfix">
															<span class="chat-img pull-right">
																<img src="/resources/images/profile/profile3.jpg" alt="User Avatar">
															</span>
															<div class="chat-body clearfix">
															<div class="header">
		...
		<!-- Datepicker -->
		<script src='/resources/js/uncompressed/datepicker.js'></script>

		<!-- Sparkline -->
		<script src='/resources/js/sparkline.min.js'></script>

		<!-- Skycons -->
		<script src='/resources/js/uncompressed/skycons.js'></script>
		...
		<!-- Sortable -->
		<script src='/resources/js/uncompressed/jquery.sortable.js'></script>
		...
		<script src="/resources/js/simplify/simplify_dashboard.js"></script>
