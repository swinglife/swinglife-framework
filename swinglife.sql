...
-- ----------------------------
BEGIN;
INSERT INTO `t_system_menu` VALUES ('9', '2016-04-27 22:57:57', '2016-04-27 22:57:57', '系统管理', '#', '系统管理菜单', '0', 'fa-desktop');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_system_permission` VALUES ('1', null, null, null, '1', null, '/home', '/home', null, null, '/home');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_system_role` VALUES ('1', null, null, '管理员', '管理员');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_system_user` VALUES ('1', null, null, '123', 'admin');
COMMIT;
